        ...
        <div class="center-box mt-3">
          <div class="row">
            ...
            while ($good = $resultFood->fetch_object()) {
              ...
              echo   "<img src='../img/food/{$good->ppic}' class='good_img food photoshadow imgee img-fluid mx-auto rounded' data-url='{$good->ppic}'>";
              echo   "</a>";
              echo   "</div>";
              echo   "<div class=' '>";
        ...
        <div class="center-box mt-3">
          <div class="row">
            ...
            while ($good = $resultGym->fetch_object()) {
              ...
              echo   "<img src='../img/gym/{$good->ppic}' class='good_img food photoshadow imgee img-fluid mx-auto rounded' data-url='{$good->ppic}' >";
              echo   "</a>";
              echo   "</div>";
              echo   "<div class=' '>";
              echo   "<div class='cen-brand head-font01'>";
